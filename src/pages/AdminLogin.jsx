      ...
      <div style={{
        ...
        <div style={{ textAlign: "center", marginBottom: "36px" }}>
          <div style={{
            ...
            marginBottom: "16px", boxShadow: "0 8px 20px rgba(11,47,91,0.2)"
          }}>
            <svg width="28" height="28" fill="none" viewBox="0 0 24 24">
              <path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z" fill="#0b2f5b"/>
            </svg>
          </div>
          <h1 style={{ margin: "0 0 4px", fontSize: "24px", fontWeight: 700, color: "#0b2f5b" }}>
            BnC Global
          </h1>
          <p style={{ margin: 0, fontSize: "14px", color: "#6b7280" }}>Admin / HR Dashboard</p>
        </div>
        ...
        <form onSubmit={handleSubmit}>
            ...
            <div style={{ position: "relative" }}>
              ...
              <input
                ...
                style={{
                  ...
                  padding: "12px 14px 12px 40px", fontSize: "14px",
            ...
            <div style={{ position: "relative" }}>
              ...
              <input
                ...
                style={{
                  width: "100%", boxSizing: "border-box",
                  border: "1.5px solid #e5e7eb", borderRadius: "12px",
                  padding: "12px 44px 12px 40px", fontSize: "14px",
                  outline: "none", transition: "border 0.2s",
                  fontFamily: "inherit", background: "#f9fafb"
                }}
                onFocus={e => e.target.style.borderColor = "#0b2f5b"}
          ...
          {error && (
            <div style={{
              ...
              color: "#dc2626", fontSize: "13px", display: "flex", gap: "8px", alignItems: "center"
            }}>
        ...
        <p style={{ textAlign: "center", marginTop: "24px", fontSize: "12px", color: "#9ca3af" }}>
          🔒 Secure Admin Access · BnC Global Recruitment
        </p>
      </div>
